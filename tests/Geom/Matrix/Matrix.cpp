...
TEST(MarixTest, SizeCheck)  // NOLINT
{
    RunTest<SizeCheckMatrixTest>();
}
...
TEST(MarixTest, Identity)  // NOLINT
{
    RunTest<IndentityMarixTest>();
}
...
TEST(MarixTest, Fill)  // NOLINT
{
    RunTest<FillMarixTest>();
}
...
TEST(VectorTest, Cross)  // NOLINT
{
    RunTest<CrossProductVectorTest>();
}
...
TEST(MarixTest, AddNumber)  // NOLINT
{
    RunTest<AddNumberMarixTest>();
}
...
TEST(MarixTest, AddMatrix)  // NOLINT
{
    RunTest<AddMatrixMarixTest>();
}
...
TEST(MarixTest, MultiplyNumber)  // NOLINT
{
    RunTest<MultiplyNumberMarixTest>();
}
...
struct MultiplyMatrixMarixTest
{
    ...
    static void Execute(Mtx a)
    {
        ExecutePasses<1, 2, 3, 4, 5, 6>(a);
    }
};

TEST(MarixTest, MultiplyMatrix)  // NOLINT
{
    RunTest<MultiplyMatrixMarixTest>();
}
