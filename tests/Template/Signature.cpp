...
struct Foo {
  ...
  SIGNATURE_TEST_METHOD(, const_volatile_noexcept_method,
                        const volatile noexcept);
  SIGNATURE_TEST_METHOD(, const_volatile_lref_noexcept_method,
                        const volatile &noexcept);
  SIGNATURE_TEST_METHOD(, const_volatile_rref_noexcept_method,
                        const volatile &&noexcept);
...
#define SIGNATURE_TEST(name, is_const, is_noexcept, is_volatile, is_pure, \
                       is_lref, is_rref)                                  \
...
SIGNATURE_TEST(const_lref_noexcept_method, true, true, false, false, true,
               false);
SIGNATURE_TEST(const_rref_noexcept_method, true, true, false, false, false,
               true);
SIGNATURE_TEST(const_volatile_method, true, false, true, false, false, false);
SIGNATURE_TEST(const_volatile_lref_method, true, false, true, false, true,
               false);
SIGNATURE_TEST(const_volatile_rref_method, true, false, true, false, false,
               true);
SIGNATURE_TEST(volatile_noexcept_method, false, true, true, false, false,
               false);
SIGNATURE_TEST(volatile_lref_noexcept_method, false, true, true, false, true,
               false);
SIGNATURE_TEST(volatile_rref_noexcept_method, false, true, true, false, false,
               true);
SIGNATURE_TEST(const_volatile_noexcept_method, true, true, true, false, false,
               false);
SIGNATURE_TEST(const_volatile_lref_noexcept_method, true, true, true, false,
               true, false);
SIGNATURE_TEST(const_volatile_rref_noexcept_method, true, true, true, false,
               false, true);
